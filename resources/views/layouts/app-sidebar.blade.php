                ...
                <nav class="mt-8 flex-1 space-y-1 px-2">
                    @php
                        $navItems = [
                            ...
                            ['route' => 'company.requisitions*', 'href' => route('company.requisitions.index'), 'label' => 'Requisitions', 'icon' => 'M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.528a3.375 3.375 0 00-3.375 3.375v2.625m3.375-3.375v-1.875a.375.375 0 01.375-.375h1.5a.375.375 0 01.375.375v1.875m-3.375 0h3.375M9 13.5V9m0 4.5h-1.5V9h1.5M12 9v4.5m3-4.5v4.5m-6-4.5v4.5m-6 9h18c.621 0 1.125-.504 1.125-1.125v-5.25c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v5.25c0 .621.504 1.125 1.125 1.125z'],
